...
REM
REM Generated by Vivado on Thu Dec 23 13:00:05 +0800 2021
...
echo "xvlog --incr --relax -prj AXI_TEST_vlog.prj"
call xvlog  --incr --relax -prj AXI_TEST_vlog.prj -log xvlog.log
