...
HD_PWD='D:/DigitalLogic/1024BitsLargeMultiplication/1024BitsLargeMultiplication.runs/Synth01'
cd "$HD_PWD"
...
EAStep vivado -log Calculate_Parellel.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Calculate_Parellel.tcl
