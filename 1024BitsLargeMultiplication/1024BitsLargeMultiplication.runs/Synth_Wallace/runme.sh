...
HD_PWD='D:/DigitalLogic/1024BitsLargeMultiplication/1024BitsLargeMultiplication.runs/Synth_Wallace'
cd "$HD_PWD"
...
EAStep vivado -log wallaceAdder_32.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source wallaceAdder_32.tcl
