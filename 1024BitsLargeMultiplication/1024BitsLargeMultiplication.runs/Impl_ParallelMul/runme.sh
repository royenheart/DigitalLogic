...
HD_PWD='D:/DigitalLogic/1024BitsLargeMultiplication/1024BitsLargeMultiplication.runs/Impl_ParallelMul'
cd "$HD_PWD"
...
EAStep vivado -log ParallelMul.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ParallelMul.tcl -notrace
