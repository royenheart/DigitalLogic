...
HD_PWD='D:/DigitalLogic/1024BitsLargeMultiplication/1024BitsLargeMultiplication.runs/Synth_Cal_Serial'
cd "$HD_PWD"
...
EAStep vivado -log Calculate_Parallel.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Calculate_Parallel.tcl
