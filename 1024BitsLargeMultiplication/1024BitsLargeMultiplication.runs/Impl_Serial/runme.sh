...
HD_PWD='D:/DigitalLogic/1024BitsLargeMultiplication/1024BitsLargeMultiplication.runs/Impl_Serial'
cd "$HD_PWD"
...
EAStep vivado -log SerialMul.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SerialMul.tcl -notrace
