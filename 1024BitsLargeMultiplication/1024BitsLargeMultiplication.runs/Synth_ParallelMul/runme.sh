...
HD_PWD='D:/DigitalLogic/1024BitsLargeMultiplication/1024BitsLargeMultiplication.runs/Synth_ParallelMul'
cd "$HD_PWD"
...
EAStep vivado -log ParallelMul.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ParallelMul.tcl
