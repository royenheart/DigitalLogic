...
HD_PWD='D:/DigitalLogic/1024BitsLargeMultiplication/1024BitsLargeMultiplication.runs/Synth_Wallace_Direct'
cd "$HD_PWD"
...
EAStep vivado -log wallaceAdder_32_Direct.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source wallaceAdder_32_Direct.tcl
