...
HD_PWD='D:/DigitalLogic/1024BitsLargeMultiplication/1024BitsLargeMultiplication.runs/lmpl_Test_Parallel'
cd "$HD_PWD"
...
EAStep vivado -log Test_Parallel.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Test_Parallel.tcl -notrace
