...
HD_PWD='D:/DigitalLogic/1024BitsLargeMultiplication/1024BitsLargeMultiplication.runs/Impl01'
cd "$HD_PWD"
...
EAStep vivado -log Calculate_Parellel.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Calculate_Parellel.tcl -notrace
