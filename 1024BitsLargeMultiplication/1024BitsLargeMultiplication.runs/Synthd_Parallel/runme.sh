...
HD_PWD='D:/DigitalLogic/1024BitsLargeMultiplication/1024BitsLargeMultiplication.runs/Synthd_Parallel'
cd "$HD_PWD"
...
EAStep vivado -log IO_ParallelMul.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source IO_ParallelMul.tcl
