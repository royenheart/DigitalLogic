...
HD_PWD='D:/DigitalLogic/1024BitsLargeMultiplication/1024BitsLargeMultiplication.runs/Impl_Parallel'
cd "$HD_PWD"
...
EAStep vivado -log IO_ParallelMul.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source IO_ParallelMul.tcl -notrace
