...
HD_PWD='D:/DigitalLogic/1024BitsLargeMultiplication/1024BitsLargeMultiplication.runs/Synth_Serial256'
cd "$HD_PWD"
...
EAStep vivado -log SerialMul256.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SerialMul256.tcl
