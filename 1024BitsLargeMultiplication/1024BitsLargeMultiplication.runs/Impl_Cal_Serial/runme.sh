...
HD_PWD='D:/DigitalLogic/1024BitsLargeMultiplication/1024BitsLargeMultiplication.runs/Impl_Cal_Serial'
cd "$HD_PWD"
...
EAStep vivado -log Calculate_Parallel.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Calculate_Parallel.tcl -notrace
