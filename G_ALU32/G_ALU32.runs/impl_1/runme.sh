...
HD_PWD='D:/DigtalLogic/G_ALU32/G_ALU32.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log G_ALU32_v1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source G_ALU32_v1.tcl -notrace
