...
HD_PWD='D:/DigtalLogic/ALU32/ALU32.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ALU32.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ALU32.tcl -notrace
